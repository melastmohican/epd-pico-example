...
#include "image_data/2.66/mocha_266_296x152_BW.cpp"
...
#define BW_monoBuffer        (uint8_t *) & mocha_266_296x152_BW
#define BW_0x00Buffer        (uint8_t *) & mocha_266_296x152_BW
#define BWR_blackBuffer        (uint8_t *) & mocha_266_296x152_BW
#define BWR_redBuffer        (uint8_t *) & mocha_266_296x152_BW
