...
#include "image_data/2.66/imagedata.cpp"
...
#define BW_monoBuffer        (uint8_t *) & epd_bitmap_mocha_mono
#define BW_0x00Buffer        (uint8_t *) & epd_bitmap_mocha_mono
#define BWR_blackBuffer        (uint8_t *) & epd_bitmap_mocha_mono
